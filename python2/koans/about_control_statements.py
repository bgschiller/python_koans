...
class AboutControlStatements(Koan):
    ...
    def test_while_statement(self):
        ...
        while i <= 10:
            result = result * i
            i += 1
        self.assertEqual(reduce(lambda x, acc: x*acc, range(1,11)), result)
    ...
    def test_continue_statement(self):
        ...
        while i < 10:
            ...
            if (i % 2) == 0: continue
            result.append(i)
        self.assertEqual(map(lambda x: 2*x + 1, range(5)), result)
    ...
    def test_for_statement(self):
        ...
        self.assertEqual(map(lambda i: i.upper(), phrase), result)
